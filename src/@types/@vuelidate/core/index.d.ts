declare module '@vuelidate/core' {
  ...
  export type ValidatorFn<T = any, K = any, S = any> = (
    value: T,
    siblingState: K,
    vm: S
  ...
  export type ValidationRuleCollection<T = any> = Record<
    string,
    ValidationRule<T>
  >
  ...
  type ExtractRuleResult<R extends ValidationRule> =
  ...
  export type ExtractState<Vargs extends ValidationArgs> =
